...
const PAGE_BODY: Record<string, { id: string; extra: string; title: string }> = {
  '/': {
    id: 'homepage',
  ...
  '/legal': {
    ...
    title: 'Legal Page | Siana Capital Management',
  },
  '/portfolio': {
    ...
    title: 'Portfolio Page | Siana Capital Management',
  },
  '/cart': {
    id: 'cart',
    extra: 'cart mobile-style-available sqs-seven-one',
    title: 'Cart | Siana Capital Management',
  },
}
